...
function _picocli_besu() {
  ...
  local NETWORK_option_args="MAINNET RINKEBY ROPSTEN SEPOLIA GOERLI SHANDONG KILN DEV CLASSIC KOTTI MORDOR ECIP1049_DEV ASTOR" # --network values
...
2022-12-09 21:48:16.737+00:00 | main | INFO  | Besu | jemalloc library not found, memory usage may be reduced by installing it
